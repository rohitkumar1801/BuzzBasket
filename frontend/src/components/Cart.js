...
const Cart = () => {
  ...
  const totalPrice = cartItems?.items?.reduce((total, item) => total + item.product.price * item.quantity, 0) || 0;
            ...
            <ul className="divide-y divide-gray-200">
              ...
              {cartItems?.items?.map((item, index) => (
                ...
                <li key={index} className="p-6 flex flex-col sm:flex-row sm:items-center">
                  <img src={item.product.thumbnail} alt={item.product.title} className="h-24 w-24 object-cover rounded-md" />
                  ...
                  <div className="mt-4 sm:mt-0 flex items-center">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="ml-4 text-red-500 hover:text-red-600 focus:outline-none p-2"
                    >
